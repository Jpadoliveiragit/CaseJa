...
![Tela inicial do sistema](evidencias/tela-inicial.png)

### Listagem de fornecedores

![Tela de listagem de fornecedores](evidencias/listagem-fornecedores.png)

### Cadastro de fornecedor

![Tela de cadastro de fornecedor](evidencias/cadastro-fornecedor.png)

### Fornecedor cadastrado

![Tela com fornecedor cadastrado](evidencias/fornecedor-cadastrado.png)

### Edição de fornecedor

![Tela de edição de fornecedor](evidencias/edicao-fornecedor.png)

### Confirmação de exclusão de fornecedor

![Tela de confirmação ou exclusão de fornecedor](evidencias/exclusao-fornecedor.png)
